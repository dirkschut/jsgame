...
let WorldMap = function(){
  ...
  this.Draw = function(){
    ...
    for(skill in game.character.skills){
      map += "<li>" + skill + " " + game.character.skills[skill].GetLevel() + " (" + game.character.skills[skill].xp + "/" + game.character.skills[skill].type.levelReqs[game.character.skills[skill].GetLevel()] + ")";
    }
    map += "</ul>";
    map += "</div>";
